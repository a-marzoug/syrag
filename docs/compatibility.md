...
| `langchain` | `pip install "syrag[langchain]"` | `langchain-text-splitters>=0.3.0` | `LangChainTextChunker` | Use LangChain text splitters behind the SyRAG `Chunker` protocol. |
