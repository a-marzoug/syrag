...
| `llamaindex` | `pip install "syrag[llamaindex]"` | `llama-index-core>=0.14.0` | `LlamaIndexNodeChunker`, `LlamaIndexRetrieverStrategy` | Use LlamaIndex node parsers and retrievers behind SyRAG protocols. |
